  ...
  return `
    ...
    <div style="background-color:#eeeeee;">
        ...
        <![endif]-->
                    ...
                    <tr>
                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', 'PingFang SC', 'Hiragino Sans GB', 'Microsoft YaHei', 'Helvetica Neue', Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';font-size:18px;line-height:1.4;text-align:left;color:#000000;">请在 10 分钟内验证您的注册邮箱。如果这不是您本人的操作，请忽略本邮件。</div>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', 'PingFang SC', 'Hiragino Sans GB', 'Microsoft YaHei', 'Helvetica Neue', Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';font-size:18px;line-height:1.4;text-align:left;color:#000000;">这是您的验证码：</div>
                        </td>
                    </tr>
                    <tr>
                        <td style="font-size:0px;word-break:break-word;">
        ...
        <![endif]-->
                    ...
                    <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                            <tr>
                            <td>
                                <!-- 显示一个六位数字验证码，参数由 verificationCode 指定,要求白底黑字,数字字号为40px,数字间距为15px,六位数字显示在一行 -->
                                <div style="font-size:40px;letter-spacing:15px;line-height:40px;text-align:center;color:#000000;background-color:#ffffff;">${verificationCode}</div>
                            </td>
                            </tr>
                        </table>
                        </td>
