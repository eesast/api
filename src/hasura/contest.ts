...
export const get_contest_settings: any = async (contest_id: string) => {
  ...
  return {
    ...
    code_upload_switch:
      query_contest_settings.contest[0]?.code_upload_switch ?? false,
    playback_switch:
      query_contest_settings.contest[0]?.playback_switch ?? false,
    playground_switch:
      query_contest_settings.contest[0]?.playground_switch ?? false,
...
export const get_compile_status: any = async (code_id: string) => {
  ...
  return {
    compile_status:
      query_compile_status.contest_team_code[0]?.compile_status ?? null,
 ...
 */
export const get_team_contest_score: any = async (
  team_id: string,
  round_id: string,
) => {
      ...
      query getTeamScore($team_id: uuid!, $round_id: uuid!) {
        contest_team_by_pk(team_id: $team_id) {
          contest_team_rooms_aggregate(
            where: { contest_room: { round_id: { _eq: $round_id } } }
          ) {
            aggregate {
              sum {
                score
  ...
  return (
    query_contest_score?.contest_team_by_pk?.contest_team_rooms_aggregate
...
export const get_team_arena_score: any = async (team_id: string) => {
  ...
  return (
    query_arena_score?.contest_team_by_pk?.contest_team_rooms_aggregate
      ?.aggregate?.sum?.score ?? 0
  );
};
 ...
 */
export const get_maneger_from_user: any = async (
  user_uuid: string,
  contest_id: string,
) => {
...
export const query_code: any = async (code_id: string) => {
  ...
  return {
    contest_id:
      query_all_from_code.contest_team_code[0]?.contest_team?.contest_id ??
      null,
    contest_name:
      query_all_from_code.contest_team_code[0]?.contest_team?.contest?.name ??
      null,
    ...
    compile_status:
      query_all_from_code.contest_team_code[0]?.compile_status ?? null,
  };
};
 ...
 */
export const count_room_team: any = async (
  contest_id: string,
  team_id: string,
) => {
...
export const get_exposed_ports: any = async () => {
  const query_exposed_ports: any = await client.request(gql`
 ...
 */
export const get_players_label: any = async (
  contest_id: string,
  team_label: string,
) => {
  ...
  return query_players_label.contest_player.map(
    (player: any) => player.player_label,
  );
};
 ...
 */
export const get_player_code: any = async (
  team_id: string,
  player_label: string,
) => {
  const query_code_id: any = await client.request(
    gql`
      query get_code_id($team_id: uuid!, $player_label: String!) {
        contest_team_player(
          where: {
            _and: { team_id: { _eq: $team_id }, player: { _eq: $player_label } }
          }
        ) {
          code_id
          role
...
export const get_contest_players: any = async (contest_id: string) => {
  ...
  return {
    team_labels: query_players.contest_player.map(
      (player: any) => player.team_label,
    ),
    players_labels: query_players.contest_player.map(
      (player: any) => player.player_label,
    ),
  };
};
 ...
 */
export const get_room_id: any = async (
  team_id: string,
  team_label: string,
  round_id: string,
) => {
        ...
        contest_room_team(
          where: {
            _and: {
              team_id: { _eq: $team_id }
              team_label: { _eq: $team_label }
              contest_room: { round_id: { _eq: $round_id } }
            }
          }
        ) {
          room_id
...
export const get_all_maps: any = async () => {
  const query_maps: any = await client.request(gql`
    query get_maps {
...
/**
 * Get the headcount of a contest team
 * @param {string} team_id      The ID of the team
 * @returns {Promise<number>}      The headcount of the team
 */
export const get_team_membercount: any = async (team_id: string) => {
  const get_team_membercount: any = await client.request(
    gql`
  ...
  return (
    get_team_membercount.contest_team[0]?.contest_team_members_aggregate
      .aggregate?.count ?? 0
  );
};

export const get_team_member_limit: any = async (team_id: string) => {
  const get_team_member_limit: any = await client.request(
    gql`
      query MyQuery($_eq: uuid!) {
        contest_team(where: { team_id: { _eq: $_eq } }) {
          contest {
            max_teammember_limit
          }
        }
      }
    `,
  ...
  return (
    get_team_member_limit.contest_team[0]?.contest?.max_teammember_limit ?? 0
  );
};

export const get_contest_member_limit: any = async (contest_id: string) => {
  const get_contest_member_limit: any = await client.request(
    gql`
      query MyQuery($_eq: uuid!) {
        contest(where: { id: { _eq: $_eq } }) {
          max_teammember_limit
        }
      }
    `,
  ...
  console.log(get_contest_member_limit);
  return get_contest_member_limit.contest[0]?.max_teammember_limit ?? 0;
};
 ...
 * @returns {string} room_id
 */
export const insert_room: any = async (
  contest_id: string,
  status: string,
  map_id: string,
) => {
    ...
    gql`
      mutation insert_room(
        ...
        insert_contest_room_one(
          object: { contest_id: $contest_id, status: $status, map_id: $map_id }
        ) {
          room_id
        }
      }
 ...
 * @returns {string} room_id
 */
export const insert_room_competition: any = async (
  contest_id: string,
  status: string,
  map_id: string,
  round_id: string,
 ...
 */
export const insert_room_teams: any = async (
  room_id: string,
  team_ids: Array<string>,
  team_labels: Array<string>,
  player_roles: Array<Array<string>>,
  player_codes: Array<Array<string>>,
) => {
 ...
 */
export const add_contest_map: any = async (
  contest_id: string,
  name: string,
  filename: string,
  team_labels: string,
 ...
 * @returns {Promise<string>}
 */
export const add_contest_notice: any = async (
  title: string,
  content: string,
  files: string,
  contest_id: string,
 ...
 * @returns {Promise<string>}
 */
export const add_contest_player: any = async (
  contest_id: string,
  team_label: string,
  player_label: string,
 ...
 */
export const add_contest_round: any = async (
  contest_id: string,
  name: string,
  map_id: string,
) => {
 ...
 * @returns {Promise<string>}    ID
 */
export const add_team_code: any = async (
  team_id: string,
  code_name: string,
  language: string,
...
export class TeamPlayerLimitError extends Error {
  constructor(message: string) {
    super(message);
    this.name = "TeamPlayerLimitError";
  }
}
 ...
 * @returns {Promise<string>}  ID
 */
export const add_team: any = async (
  team_name: string,
  team_intro: string,
  team_leader_uuid: string,
  invited_code: string,
 ...
 * @returns {Promise<string>}  ID
 */
export const add_team_member: any = async (
  team_id: string,
  user_uuid: string,
) => {
 ...
 * @returns {Promise<string>}
 */
export const add_contest_time: any = async (
  contest_id: string,
  event: string,
  start: Date,
  end: Date,
 ...
 * @returns {number} affected_rows
 */
export const update_compile_status: any = async (
  code_id: string,
  compile_status: string,
) => {
  const update_compile_status: any = await client.request(
    gql`
      mutation update_compile_status(
        ...
        update_contest_team_code(
          where: { code_id: { _eq: $code_id } }
          _set: { compile_status: $compile_status }
        ) {
          affected_rows
        }
      }
 ...
 * @returns {number} affected_rows
 */
export const update_room_status_and_port: any = async (
  room_id: string,
  status: string,
  port: number | null,
) => {
 ...
 * @returns {number} affected_rows
 */
export const update_room_status: any = async (
  room_id: string,
  status: string,
) => {
  const update_room_status: any = await client.request(
 ...
 * @returns {number} affected_rows
 */
export const update_room_port: any = async (
  room_id: string,
  port: number | null,
) => {
  const update_room_status: any = await client.request(
 ...
 * @param {number} score
 */
export const update_room_team_score: any = async (
  room_id: string,
  team_id: string,
  score: number,
) => {
  const update_room_team_score: any = await client.request(
    gql`
      mutation update_room_team_score(
        $room_id: uuid!
        $team_id: uuid!
        $score: Int!
      ) {
        update_contest_room_team(
          where: {
            _and: { room_id: { _eq: $room_id }, team_id: { _eq: $team_id } }
          }
          _set: { score: $score }
        ) {
          affected_rows
 ...
 * @param {string[][]} player_roles
 */
export const update_room_team_player_roles: any = async (
  room_id: string,
  team_ids: string[],
  player_roles: string[][],
) => {
  ...
  for (let i = 0; i < team_ids.length; i++) {
    const mutation = gql`
      mutation update_team_player_roles(
        $room_id: uuid!
        $team_id: uuid!
        $player_roles: String!
      ) {
 ...
 */
export const update_room_created_at: any = async (
  room_id: string,
  created_at: string,
) => {
  const update_room_created_at: any = await client.request(
    gql`
      mutation update_room_created_at(
        $room_id: uuid!
        $created_at: timestamptz = ""
      ) {
        update_contest_room_by_pk(
 ...
 */
export const update_contest_info: any = async (
  contest_id: string,
  ...
  if (updateFields.description)
    setFields.description = updateFields.description;
 ...
 * @returns {string} The ID of the updated contest.
 */
export const update_contest_switch: any = async (
  contest_id: string,
  team_switch: boolean,
 ...
 */
export const update_contest_map: any = async (
  map_id: string,
  updateFields: Partial<{
    name: string;
    filename: string;
  ...
  if (updateFields.team_labels)
    setFields.team_labels = updateFields.team_labels;
 ...
 */
export const update_contest_notice: any = async (
  id: string,
  updateFields: Partial<{ title: string; content: string; files: string }>,
) => {
  const setFields: any = {};
 ...
 */
export const update_contest_player: any = async (
  contest_id: string,
  player_label: string,
  team_label: string,
  updateFields: Partial<{ roles_available: string }>,
) => {
  const setFields: any = {};
  if (updateFields.roles_available)
    setFields.roles_available = updateFields.roles_available;
  ...
  if (setFields.roles_available)
    variables.roles_available = setFields.roles_available;
 ...
 */
export const update_contest_round_name: any = async (
  round_id: string,
  name: string,
) => {
  ...
  return (
    update_contest_round_name.update_contest_round_by_pk?.round_id ?? undefined
  );
};
 ...
 */
export const update_team_code_name: any = async (
  code_id: string,
  code_name: string,
) => {
  ...
  return (
    update_team_code_name.update_contest_team_code_by_pk?.code_id ?? undefined
  );
};
 ...
 */
export const update_team_player: any = async (
  team_id: string,
  player: string,
  code_id: string,
  role: string,
  ...
  return (
    update_team_player.update_contest_team_player_by_pk?.player ?? undefined
  );
};
...
export const update_team: any = async (
  team_id: string,
  updateFields: Partial<{ team_name: string; team_intro: string }>,
) => {
  const setFields: any = {};
...
export const update_contest_time: any = async (
  contest_id: string,
  event: string,
  start: Date,
  end: Date,
...
export const delete_contest_player: any = async (
  contest_id: string,
  team_label: string,
  player_label: string,
) => {
  ...
  return (
    delete_contest_player.delete_contest_player_by_pk?.team_label ?? undefined
  );
};
...
export const delete_team_member: any = async (
  user_uuid: string,
  team_id: string,
) => {
  const delete_team_member: any = await client.request(
    gql`
      mutation DeleteTeamMember($user_uuid: uuid!, $team_id: uuid!) {
        delete_contest_team_member_by_pk(
          user_uuid: $user_uuid
          team_id: $team_id
        ) {
          team_id
  ...
  return (
    delete_team_member.delete_contest_team_member_by_pk?.team_id ?? undefined
  );
};
...
export const delete_contest_time: any = async (
  contest_id: string,
  event: string,
) => {
